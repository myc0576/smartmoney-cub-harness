...
from smartmoney_cub import __version__
from smartmoney_cub.agent_trigger import AgentIntent, normalize_agent_trigger_text, resolve_agent_trigger
...
from smartmoney_cub.run_capture import capture_run, get_command_preset
from smartmoney_cub.safety import redact
from smartmoney_cub.schemas import SAFETY_DECLARATION, VALID_HORIZONS
    ...
    return "\n".join(
        [
            ...
            *[f"| {key} | {value} |" for key, value in scores.items()],
            ...
            "## What this proves",
            "",
            "* SmartMoney-Cub can run an offline loop",
            "* SmartMoney-Cub can log decisions",
            "* SmartMoney-Cub can evaluate outcomes",
            "* SmartMoney-Cub can propose challenger rules safely",
            "",
